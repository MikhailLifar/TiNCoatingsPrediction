...
class FuncModel:
    ...
    @staticmethod
    def makeMixture(funcModelList, expDataItemNames='exp', distToExperiment=None, mixDataItemNames=None, errorDataItemNames=None, plotIndividual=False, commonParamNames=None, additionalFunc=None):
        """
